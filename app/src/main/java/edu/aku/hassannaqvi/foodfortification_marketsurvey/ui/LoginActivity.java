...
import edu.aku.hassannaqvi.foodfortification_marketsurvey.MainActivity;
import edu.aku.hassannaqvi.foodfortification_marketsurvey.R;
import edu.aku.hassannaqvi.foodfortification_marketsurvey.core.AppInfo;
import edu.aku.hassannaqvi.foodfortification_marketsurvey.core.MainApp;
import edu.aku.hassannaqvi.foodfortification_marketsurvey.database.CreateTable;
import edu.aku.hassannaqvi.foodfortification_marketsurvey.database.DatabaseHelper;
import edu.aku.hassannaqvi.foodfortification_marketsurvey.databinding.ActivityLoginBinding;
...
*//*
    ...
    public void onSyncDataClick(View view) {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            startActivity(new Intent(this, edu.aku.hassannaqvi.foodfortification_marketsurvey.ui.SyncActivity.class).putExtra("login", true));
        } else {
    ...
    public void attemptLogin(View view) {
        ...
        if (attemptCounter == 7) {
            ...
            if ((username.equals("dmu@aku") && password.equals("aku?dmu"))
                ...
                Toast.makeText(edu.aku.hassannaqvi.foodfortification_marketsurvey.ui.LoginActivity.this, username + " " + password, Toast.LENGTH_SHORT).show();
            }
