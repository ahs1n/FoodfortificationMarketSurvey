...
public class Form extends BaseObservable implements Observable {
    ...
    private String a11902 = _EMPTY_;
    private String a11903 = _EMPTY_;
    ...
    private String b12901 = _EMPTY_;
    private String b12902 = _EMPTY_;
    private String b12903 = _EMPTY_;
    private String b12904 = _EMPTY_;
    private String b12996 = _EMPTY_;
    private String b12996x = _EMPTY_;
    private String b12998 = _EMPTY_;
    ...
    private String sd10604 = _EMPTY_;
    ...
    private String e13308 = _EMPTY_;
    private String e13308x = _EMPTY_;
    ...
    @Bindable
    public String getA11902() {
        return a11902;
    }

    public void setA11902(String a11902) {
        this.a11902 = a11902;
        notifyPropertyChanged(BR.a11902);
    }

    @Bindable
    public String getA11903() {
        return a11903;
    }

    public void setA11903(String a11903) {
        this.a11903 = a11903;
        notifyPropertyChanged(BR.a11903);
    }
    ...
    public void setB107(String b107) {
        this.b107 = b107;
        setB10701x(b107.equals("1") ? this.b10701x : ""); // for all skips, mention all skipped questions
        setB10702x(b107.equals("2") ? this.b10702x : ""); // for all skips, mention all skipped questions
        setB10703x(b107.equals("3") ? this.b10703x : ""); // for all skips, mention all skipped questions
        setB10704x(b107.equals("4") ? this.b10704x : ""); // for all skips, mention all skipped questions
        setB10705x(b107.equals("5") ? this.b10705x : ""); // for all skips, mention all skipped questions
        setB10706x(b107.equals("6") ? this.b10706x : ""); // for all skips, mention all skipped questions
        setB10796x(b107.equals("96") ? this.b10796x : ""); // for all skips, mention all skipped questions
    ...
    public void setB114(String b114) {
        ...
        setB123(b114.equals("1") ? this.b123 : "");
    ...
    public void setB123(String b123) {
        this.b123 = b123;
        setB12301x(b123.equals("1") ? this.b12301x : ""); // for all skips, mention all skipped questions
        setB12302x(b123.equals("2") ? this.b12302x : ""); // for all skips, mention all skipped questions
        setB12303x(b123.equals("3") ? this.b12303x : ""); // for all skips, mention all skipped questions
        setB12304x(b123.equals("4") ? this.b12304x : ""); // for all skips, mention all skipped questions
        setB12305x(b123.equals("5") ? this.b12305x : ""); // for all skips, mention all skipped questions
        setB12306x(b123.equals("6") ? this.b12306x : ""); // for all skips, mention all skipped questions
        setB12396x(b123.equals("96") ? this.b12396x : ""); // for all skips, mention all skipped questions
    ...
    @Bindable
    public String getB12901() {
        return b12901;
    }

    public void setB12901(String b12901) {
        if (this.b12901.equals(b12901)) return; // for all checkboxes
        this.b12901 = b12901;
        notifyPropertyChanged(BR.b12901);
    }

    @Bindable
    public String getB12902() {
        return b12902;
    }

    public void setB12902(String b12902) {
        if (this.b12902.equals(b12902)) return; // for all checkboxes
        this.b12902 = b12902;
        notifyPropertyChanged(BR.b12902);
    }

    @Bindable
    public String getB12903() {
        return b12903;
    }

    public void setB12903(String b12903) {
        if (this.b12903.equals(b12903)) return; // for all checkboxes
        this.b12903 = b12903;
        notifyPropertyChanged(BR.b12903);
    }

    @Bindable
    public String getB12904() {
        return b12904;
    }

    public void setB12904(String b12904) {
        if (this.b12904.equals(b12904)) return; // for all checkboxes
        this.b12904 = b12904;
        notifyPropertyChanged(BR.b12904);
    }

    @Bindable
    public String getB12996() {
        return b12996;
    }

    public void setB12996(String b12996) {
        if (this.b12996.equals(b12996)) return; // for all checkboxes
        this.b12996 = b12996;
        setB12996x(b12996.equals("96") ? this.b12996x : ""); // for all skips, mention all skipped questions
        notifyPropertyChanged(BR.b12996);
    }
    ...
    @Bindable
    public String getB12998() {
        return b12998;
    }

    public void setB12998(String b12998) {
        if (this.b12998.equals(b12998)) return; // for all checkboxes
        this.b12998 = b12998;
        setB12901(b12998.equals("98") ? "" : this.b12901);
        setB12902(b12998.equals("98") ? "" : this.b12902);
        setB12903(b12998.equals("98") ? "" : this.b12903);
        setB12904(b12998.equals("98") ? "" : this.b12904);
        setB12996(b12998.equals("98") ? "" : this.b12996);
        notifyPropertyChanged(BR.b12998);
    }
    ...
    @Bindable
    public String getSd10604() {
        return sd10604;
    }

    public void setSd10604(String sd10604) {
        this.sd10604 = sd10604;
        notifyPropertyChanged(BR.sd10604);
    }
    ...
    public void setD1208(String d1208) {
        this.d1208 = d1208;
        notifyPropertyChanged(BR.d1208);
    }
    ...
    @Bindable
    public String getE13308() {
        return e13308;
    }

    public void setE13308(String e13308) {
        this.e13308 = e13308;
        notifyPropertyChanged(BR.e13308);
    }

    @Bindable
    public String getE13308x() {
        return e13308x;
    }

    public void setE13308x(String e13308x) {
        this.e13308x = e13308x;
        notifyPropertyChanged(BR.e13308x);
    }
   ...
   /* public String getsH2a() {
    ...
    public void sAHydrate(String string) throws JSONException {
        ...
        if (string != null) {
            ...
            this.a11902 = json.getString("a11902");
            this.a11903 = json.getString("a11903");
    ...
    public void sBHydrate(String string) throws JSONException {
        ...
        if (string != null) {
            ...
            this.b12901 = json.getString("b12901");
            this.b12902 = json.getString("b12902");
            this.b12903 = json.getString("b12903");
            this.b12904 = json.getString("b12904");
            this.b12996 = json.getString("b12996");
            this.b12996x = json.getString("b12996x");
            this.b12998 = json.getString("b12998");
    ...
    public void sDHydrate(String string) throws JSONException {
        ...
        if (string != null) {
            ...
            this.sd10604 = json.getString("sd10604");
            ...
            this.d1208 = json.getString("d1208");
    ...
    public void sEHydrate(String string) throws JSONException {
        ...
        if (string != null) {
            ...
            this.e13308 = json.getString("e13308");
            this.e13308x = json.getString("e13308x");
